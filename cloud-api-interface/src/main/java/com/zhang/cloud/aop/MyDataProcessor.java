 ...
 * @author 98549
 */
@SupportedAnnotationTypes(value = {"com.zhang.cloud.aop.MyData"})
...
public class MyDataProcessor extends AbstractProcessor {
    ...
    private JCTree.JCAnnotation makeAnnotation(){
        return treeMaker.Annotation(
                treeMaker.Ident(names.fromString("RestController")),
                List.nil());
    }
    ...
    private JCTree.JCMethodDecl makeGetterMethodDecl(JCTree.JCVariableDecl jcVariableDecl) {
        ...
        messager.printMessage(Diagnostic.Kind.NOTE, "@MyData process [" + jcVariableDecl.name.toString() + "] 设置成功!");
        //构建方法
